...
abstract class $AddressModelCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {double lat, double lon, String name, String country, String state});
}
...
class _$_AddressModel with DiagnosticableTreeMixin implements _AddressModel {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'AddressModel(lat: $lat, lon: $lon, name: $name, country: $country, state: $state)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, lat, lon, name, country, state);
...
abstract class _AddressModel implements AddressModel {
  factory _AddressModel(
      ...
      required final String state}) = _$_AddressModel;
